...
function closeModalAndSubmit() {
    if (document.getElementById('name_std').value && document.getElementById('mail_std').value && document.getElementById('password_std').value) {
        ...
        var urlRegister = 'http://192.168.251.33:5050/api/user/register';
...
document.addEventListener('DOMContentLoaded', function() {
    const url = 'http://192.168.251.33:5050/api/user/getalluser';
...
function showUserDetails(userId) {
    const urlGetAllUsers = 'http://192.168.251.33:5050/api/user/getalluser ';
